...
interface SeriesSeed {
  ...
  wordSplit: number
  description: string
  /** 系列頁首圖編號（滿版出血會裁掉上下，橫式優先——橫式只有 01~09、37、43、45、48） */
  cover: number
  /** 首圖的垂直裁切錨點；直式照片要把這個值調到人臉的高度，否則寬版裁切會切到頭 */
  coverFocus: string
  /** 頁尾「下一個系列」預告卡編號（非直視鏡頭，橫式優先——橫式只有 01~09、37、43、45、48） */
  preview: number
  /**
   * PublicMenu 目錄列的縮圖編號。那裡是 3:2 置中裁切，直式會切掉頭或半身，
   * 所以只准填橫式（01~09、37、43、45、48）；city 系列到第二批仍沒有橫式照片，只能借別組的一張。
   */
  menuThumb: number
...
const SERIES_SEEDS: SeriesSeed[] = [
  {
    ...
    artwork: 'meadow.webp',
    windmills: true,
    // 第二批穿插進第一批之間（不是接在尾巴），系列頁往下捲兩批才會交錯出現；showcase 也換進四張第二批，且不再用 hero 那張（01）
    showcase: [46, 23, 41, 38, 25, 49, 21],
    nums: [1, 2, 45, 3, 4, 41, 5, 37, 15, 16, 46, 17, 18, 47, 19, 20, 38, 21, 22, 49, 23, 24, 48, 25, 39],
  },
  {
    slug: 'seaside',
    title: 'By the Ocean',
    ...
    bubbles: true,
    showcase: [28, 42, 31, 44, 9, 50, 32],
    nums: [6, 7, 43, 8, 9, 26, 44, 27, 28, 42, 29, 30, 31, 50, 32, 33],
  },
  {
    slug: 'city',
    title: 'In the City',
