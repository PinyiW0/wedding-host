...
![桌次排席演示——手動入座與推薦排序自動帶位](docs/demo/seating.gif)

*桌次規劃：以圓桌呈現現場佈局，賓客從名單點選或拖曳入座；「推薦排序」依主桌帶入新人與雙親、男左女右、長輩近主桌的禮俗自動帶位。*
...
**賓客名單**——後台新增一位賓客：填寫姓名、分類、聯絡方式，送出後立即出現在名單上：

![賓客名單操作演示](docs/demo/guests.gif)
